...
export default function Desktop() {
  ...
  const categoryColors = {
    ...
    system: { primary: '#F59E0B', secondary: '#FBBF24', glow: 'rgba(245, 158, 11, 0.4)' }, // Ámbar
  ...
  // Función para generar estilos dinámicos de hover
    ...
    if (!window.windowManager) {
      window.windowManager = {
        openApp: (appName) => {
          ...
          // El WindowManager de React se encargará de esto
        },
        closeApp: (id) => {
